...
data modify storage player_inv:temp Items append from entity @s Inventory[]

execute store result score #slot_count gm4_translation_value if data storage player_inv:temp Items[]
